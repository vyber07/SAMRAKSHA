...
const NAV_SECTIONS = [
  {
    ...
    items: [
      ...
      { to: '/assistant', icon: 'smart_toy', label: 'Assistant', gradient: 'linear-gradient(135deg, #a855f7, #7e22ce)' },
    ],
  },
  {
    title: 'Operations',
    items: [
      ...
      { to: '/documents', icon: 'description', label: 'Documents', gradient: 'linear-gradient(135deg, #6366f1, #4338ca)' },
