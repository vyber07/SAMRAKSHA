...
## Corpus Check
- 65 files · ~38,360 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 490 nodes · 756 edges · 28 communities (20 shown, 8 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 64 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1de3cf56`
...
Cohesion: 0.06
Nodes (50): AsyncSession, get_dashboard_summary(), get_trends(), BaseModel, simulate_event(), SimulateRequest, AssistantQuery, BaseModel (+42 more)
...
Cohesion: 0.18
Nodes (10): CCTVAlertRequest, check_anpr_match(), ingest_alert(), BaseModel, simulate_dcp_escalation(), DashboardManager, websocket_endpoint(), get_db() (+2 more)
...
- **Why does `fetch_one()` connect `DesignSystemGenerator` to `DashboardManager`, `patrol.py`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `execute()` connect `DesignSystemGenerator` to `DashboardManager`, `patrol.py`?**
